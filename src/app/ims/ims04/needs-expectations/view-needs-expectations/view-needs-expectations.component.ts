...
@Component({
  selector: 'app-view-needs-expectations',
  templateUrl: './view-needs-expectations.component.html',
  styleUrls: ['./view-needs-expectations.component.scss']
})
export class ViewNeedsExpectationsComponent implements OnInit {
